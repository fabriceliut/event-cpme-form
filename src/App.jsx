  ...
  return (
    <div className="min-h-screen pb-32">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm">
        ...
        {/* Stepper + Demo */}
        <div className="max-w-4xl mx-auto px-4 md:px-6 pb-4 pt-2 flex items-center gap-3">
          <div className="flex-1">
            <Stepper current={step} />
          </div>
          <button
            onClick={() => { fillDemo(); setStep(1); setErrors([]); setShowErrors(false) }}
            className="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold text-amber-600 bg-amber-50 hover:bg-amber-100 border border-amber-200 transition-colors"
